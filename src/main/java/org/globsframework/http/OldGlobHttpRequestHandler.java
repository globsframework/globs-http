...
// */
//public class OldGlobHttpRequestHandler {
//    private static final Logger LOGGER = LoggerFactory.getLogger(OldGlobHttpRequestHandler.class);
//
...
//
//    public OldGlobHttpRequestHandler(String serverInfo, HttpReceiver httpReceiver) {
