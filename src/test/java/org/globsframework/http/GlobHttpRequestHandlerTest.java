...
public class GlobHttpRequestHandlerTest {
    ...
    public void openApiScope() throws IOException, InterruptedException {
...

        {
            ...
            String expectedBody = "{\"openapi\":\"3.0.1\",\"info\":{\"title\":\"PriceServer/1.1\",\"description\":\"PriceServer/1.1\",\"version\":\"1.0\"},\"components\":{\"schemas\":{\"openApiServers\":{\"type\":\"object\",\"properties\":{\"url\":{\"type\":\"string\"},\"description\":{\"type\":\"string\"}}},\"openApiInfo\":{\"type\":\"object\",\"properties\":{\"title\":{\"type\":\"string\"},\"description\":{\"type\":\"string\"},\"version\":{\"type\":\"string\"}}},\"openApiSchemaProperty\":{\"type\":\"object\",\"properties\":{\"name\":{\"type\":\"string\"},\"type\":{\"type\":\"string\"},\"anyOf\":{\"type\":\"array\",\"items\":{\"$ref\":\"#/components/schemas/openApiSchemaProperty\"}},\"format\":{\"type\":\"string\"},\"minimum\":{\"type\":\"integer\",\"format\":\"int32\"},\"maximum\":{\"type\":\"integer\",\"format\":\"int32\"},\"properties\":{\"type\":\"array\",\"items\":{\"$ref\":\"#/components/schemas/openApiSchemaProperty\"}},\"items\":{\"$ref\":\"#/components/schemas/openApiSchemaProperty\"},\"$ref\":{\"type\":\"string\"}}},\"openApiType\":{\"type\":\"object\",\"properties\":{\"openapi\":{\"type\":\"string\"},\"info\":{\"$ref\":\"#/components/schemas/openApiInfo\"},\"components\":{\"$ref\":\"#/components/schemas/openApiComponents\"},\"servers\":{\"type\":\"array\",\"items\":{\"$ref\":\"#/components/schemas/openApiServers\"}},\"paths\":{\"type\":\"array\",\"items\":{\"$ref\":\"#/components/schemas/openApiPath\"}}}},\"openApiParameter\":{\"type\":\"object\",\"properties\":{\"in\":{\"type\":\"string\"},\"name\":{\"type\":\"string\"},\"description\":{\"type\":\"string\"},\"required\":{\"type\":\"boolean\"},\"schema\":{\"$ref\":\"#/components/schemas/openApiSchemaProperty\"}}},\"queryParameter\":{\"type\":\"object\",\"properties\":{\"name\":{\"type\":\"string\"},\"info\":{\"type\":\"array\",\"items\":{\"type\":\"string\"}},\"param\":{\"$ref\":\"#/components/schemas/queryParameter\"}}},\"openApiComponents\":{\"type\":\"object\",\"properties\":{\"schemas\":{\"type\":\"array\",\"items\":{\"$ref\":\"#/components/schemas/openApiSchemaProperty\"}}}},\"openApiBodyMimeType\":{\"type\":\"object\",\"properties\":{\"mimeType\":{\"type\":\"string\"},\"schema\":{\"$ref\":\"#/components/schemas/openApiSchemaProperty\"}}},\"openApiPathDsc\":{\"type\":\"object\",\"properties\":{\"tags\":{\"type\":\"array\",\"items\":{\"type\":\"string\"}},\"summary\":{\"type\":\"string\"},\"description\":{\"type\":\"string\"},\"operationId\":{\"type\":\"string\"},\"parameters\":{\"type\":\"array\",\"items\":{\"$ref\":\"#/components/schemas/openApiParameter\"}},\"requestBody\":{\"$ref\":\"#/components/schemas/openApiRequestBody\"},\"responses\":{\"type\":\"array\",\"items\":{\"$ref\":\"#/components/schemas/openApiResponses\"}}}},\"openApiRequestBody\":{\"type\":\"object\",\"properties\":{\"description\":{\"type\":\"string\"},\"required\":{\"type\":\"boolean\"},\"content\":{\"type\":\"array\",\"items\":{\"$ref\":\"#/components/schemas/openApiBodyMimeType\"}}}},\"openApiResponses\":{\"type\":\"object\",\"properties\":{\"code\":{\"type\":\"string\"},\"description\":{\"type\":\"string\"},\"content\":{\"type\":\"array\",\"items\":{\"$ref\":\"#/components/schemas/openApiBodyMimeType\"}}}},\"openApiPath\":{\"type\":\"object\",\"properties\":{\"name\":{\"type\":\"string\"},\"put\":{\"$ref\":\"#/components/schemas/openApiPathDsc\"},\"post\":{\"$ref\":\"#/components/schemas/openApiPathDsc\"},\"patch\":{\"$ref\":\"#/components/schemas/openApiPathDsc\"},\"get\":{\"$ref\":\"#/components/schemas/openApiPathDsc\"},\"delete\":{\"$ref\":\"#/components/schemas/openApiPathDsc\"}}}}},\"servers\":[{\"url\":\"http://localhost:" + port + "\"}],\"paths\":{\"/test/{id}\":{\"get\":{\"tags\":[\"test-scope\"],\"parameters\":[{\"in\":\"path\",\"name\":\"id\",\"required\":true,\"schema\":{\"type\":\"integer\",\"format\":\"int64\"}},{\"in\":\"query\",\"name\":\"name\",\"required\":true,\"schema\":{\"type\":\"string\"}},{\"in\":\"query\",\"name\":\"info\",\"required\":true,\"schema\":{\"type\":\"array\",\"items\":{\"type\":\"string\"}}},{\"in\":\"query\",\"name\":\"param\",\"required\":true,\"schema\":{\"$ref\":\"#/components/schemas/queryParameter\"}}],\"responses\":{\"200\":{\"description\":\"None\"}}}}}}";
